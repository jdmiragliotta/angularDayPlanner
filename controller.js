...
(function() {
    ...
    app.controller('ScheduleController', ['$http', function($http) {
        ...
        var am = ["twelve-am", "one-am", "two-am", "three-am", "four-am", "five-am", "six-am", "seven-am", "eight-am", "nine-am", "ten-am", "eleven-am"];
        var pm = ["twelve-pm", "one-pm", "two-pm", "three-pm", "four-pm", "five-pm", "six-pm", "seven-pm", "eight-pm", "nine-pm", "ten-pm", "eleven-pm"];
